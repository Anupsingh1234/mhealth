...
const WhatsappReport = (props) => {
  ...
  const handleChange = (e) => {
    const URL =
      currDate == ""
        ? `${urlPrefix}v1.0/whatsAppExceptionKeyword?date=${props.todDate}`
        : `${urlPrefix}v1.0/whatsAppExceptionKeyword?date=${currDate}`;
  ...
  return (
    <>
      ...
      <div className="flex justify-start md:justify-center ml-4 mb-4">
                  ...
                  return (
                    <>
                      <TableRow>
                        ...
                        <TableCell
                          align="center"
                          style={{ textAlign: "justify", width: 250 }}
                        >
                          {" "}
                          {item.data}{" "}
                        </TableCell>
