...
const ConsistantPlayer = (props) => {
  ...
  const headers = [
    ...
    {label: 'Day Count', key: 'daysCnt'},
    {label: 'km', key: 'kms'},
    {label: 'Average', key: 'avrg'},
  ];
  const datas = props.consistantPlayer;
        ...
        >
          ...
          <div className="d-flex a-i-center">
            <TablePagination
              ...
              component="div"
              count={props.consistantPlayer.length}
        ...
        <div style={{minHeight: '200px', padding: 30, overflowX: 'scroll'}}>
          {props.consistantPlayer ? (
            ...
            >
              ...
              />
              {stableSort(props.consistantPlayer, getComparator(order, orderBy))
                  ...
                  return (
                    <>
                      <TableRow>
                        ...
                        <TableCell align="center"> {item.daysCnt}</TableCell>
                        <TableCell align="center"> {item.kms}</TableCell>
                        <TableCell align="center"> {item.avrg}</TableCell>
                      </TableRow>
                    </>
                  );
                })}
...
export default ConsistantPlayer;
