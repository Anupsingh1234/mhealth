...
const CompnyForm = ({userData, loaderInfo, handleInput, handleInfoSubmit}) => (
  <>
    ...
    <span style={{fontSize: '10px', color: 'red', marginLeft: '20px'}}>
      {' '}
      * Firsr character of PIN must be between 1-9{' '}
    </span>
