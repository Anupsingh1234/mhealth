          ...
          <div style={{ position: "relative" }}>
            <div>
              ...
              <div style={{ fontSize: 12 }}>
                ...
                {type && type == "program" && (
                  <div>
                    Coach/Partner: <span>{challenge?.coachName}</span>{" "}
                  </div>
                )}
              </div>
            </div>
            <div style={{ marginBottom: 5, marginTop: "0.5em" }}>
              <div style={{ fontWeight: 800 }}>Program Description</div>
              <div style={{ fontSize: 12 }}>
            ...
            {challenge.rules && (
              <div style={{ marginBottom: 5, marginTop: "0.5em" }}>
                <div style={{ fontWeight: 800 }}>Rules & Regulation</div>
            ...
            {challenge.rewards && (
              <div style={{ marginBottom: 5, marginTop: "0.5em" }}>
                <div style={{ fontWeight: 800 }}>Rewards & Recognition</div>
            ...
            {challenge.reward && (
              <div style={{ marginBottom: 5, marginTop: "0.5em" }}>
                <div style={{ fontWeight: 800 }}>Reward & Recognition</div>
