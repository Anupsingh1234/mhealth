...
export default function HraReport({ hraModal, setHraModal }) {
        ...
        <div>
          <TableContainer>
            ...
            {attendUserDetail.hraScoreCard ? (
              ...
              >
                Hra Name : {attendUserDetail.hraScoreCard.assesmentName}
              </div>
            ) : (
              ""
            )}
            ...
            >
              ...
              >
                ...
                <div className="d-flex a-i-center">
                  ...
                  attendUserDetail.hrQueAns.length > 0 ? (
                    <TablePagination
                      rowsPerPageOptions={[5, 10, 50, 75, 100]}
                      component="div"
                      count={
                        attendUserDetail.hrQueAns &&
                        attendUserDetail.hrQueAns.length
                      }
            ...
            {attendUserDetail.hraScoreCard ? (
              <>
                <div style={{ marginLeft: "20px", fontWeight: "800px" }}>
                  Total Score : {attendUserDetail.hraScoreCard.totalScore}
                </div>
                ...
                >
                  ...
                  >
                    <u>Assessment Report :</u>
                  </span>
                  {attendUserDetail.hraScoreCard.description} <br />{" "}
                  {attendUserDetail.hraScoreCard.recommedations}
                </div>
              </>
            ) : (
              ""
