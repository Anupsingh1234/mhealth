...
const CreateActivityModal = ({
  ...
  const getDisableStatus = () => {
    ...
    if (activeStep == 1) {
      ...
      delete checkObject.sessionDuration;
      delete checkObject.gapBetweenSession;
      delete checkObject.eventNature;
      delete checkObject.activationLink;
      delete checkObject.zoomMeetingId;
      delete checkObject.associateName;
            ...
            <>
                ...
                <div style={{ width: "50%", display: "flex" }}>
                  ...
                  <div style={{ width: "50%" }}>
                    ...
                    >
                      ...
                      <option value="HEALTH_TALKS">Health Talks</option>
                      <option value="PRO_FITNESS">Pro Fitness</option>
              ...
              >
                ...
                <div style={{ width: "50%", display: "flex" }}>
                  ...
                  {eventObject.eventNature === "ASSOCIATE" ? (
                    <div
                      style={{
                        width: "50%",
                        display: "flex",
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("associateName", e.target.value)
                        }
                        value={eventObject.associateName}
                      />
                    </div>
                  ) : (
                    ""
