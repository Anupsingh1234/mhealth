...
const Programs = (props) => {
  ...
  useEffect(() => {
    if (dashboardState.listOfChallenges.length > 0) {
      ...
      if (isAnyEventSubscribed === 0 && localStorage.view !== "program") {
        window.location.replace("/#/default-view");
      }
    }
